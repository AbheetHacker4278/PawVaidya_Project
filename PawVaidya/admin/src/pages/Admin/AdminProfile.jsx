...
const AdminProfile = () => {
    const { backendurl, atoken, getAdminProfile } = useContext(AdminContext);
    ...
    const handleProfileUpdate = async () => {
        ...
        try {
            ...
            if (data.success) {
                ...
                // Refresh admin profile in context to update navbar
                if (getAdminProfile) {
                    getAdminProfile();
                }
            } else {
                        ...
                        <div className="flex flex-col items-center">
                            <div className="relative group">
                                <img
                                    ...
                                    alt="Admin"
                                    className="w-32 h-32 rounded-full object-cover border-4 border-green-200 group-hover:border-green-400 transition-all duration-300 shadow-lg"
                                />
                                <label className="absolute bottom-0 right-0 bg-gradient-to-r from-green-500 to-emerald-600 text-white p-2.5 rounded-full cursor-pointer hover:from-green-600 hover:to-emerald-700 transition-all duration-300 transform hover:scale-110 shadow-lg">
                                    <input
                                        type="file"
                                        onChange={(e) => {
                            ...
                            <p className="text-xs text-gray-500 mt-1">Click camera to change</p>
                        </div>
                            ...
                            {isEdit && (
                                <div className="flex gap-3 pt-4">
                                    <button
                                        ...
                                        disabled={isLoading}
                                        className="flex-1 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-3 rounded-lg hover:from-green-600 hover:to-emerald-700 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
                                    >
