...
const DoctorsList = () => {
  const { doctors, atoken, getalldoctors, changeavailablity, deleteDoctor, makeAllDoctorsAvailable, getDoctorsWithPasswords, getActivityLogs, banUser, unbanUser } = useContext(AdminContext)
        ...
        <div className='p-5'>
          ...
          <div className='flex items-center gap-2 mb-4 p-2 bg-gray-100 rounded-lg'>
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              <div className={`w-11 h-6 bg-gray-300 peer-focus:outline-none rounded-full peer ${
                doctor.available ? 'peer-checked:bg-green-500' : 'peer-checked:bg-red-500'
                ...
                doctor.available ? 'peer-checked:border-green-500' : 'peer-checked:border-red-500'
              }`}></div>
            </label>
          ...
          <div className='grid grid-cols-3 gap-2'>
            <button
              ...
              disabled={isDeleting}
              className={`flex items-center justify-center gap-1 py-2 px-3 rounded-lg font-medium text-sm transition-all duration-200 ${
                isDeleting 
    ...
    <div className='p-4 md:p-6 lg:p-8 max-h-[90vh] overflow-y-auto'>
      ...
      <div className='flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4'>
        ...
        <button
          ...
          className={`flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 ${
