...
const TotalUsers = () => {
    const { users, getallusers, dashdata, getdashdata, deleteUser, editUser, getUsersWithPasswords, getActivityLogs, getRealtimeActivityLogs, sendVerificationEmail, banUser, unbanUser } = useContext(AdminContext);
