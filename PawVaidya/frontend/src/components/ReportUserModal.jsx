...
const ReportUserModal = ({ appointment, onClose }) => {
  const { backendurl, token, doctordata } = useContext(AppContext);
  ...
  const reportReasons = [
    ...
    { value: 'no_show', label: 'No Show / Missed Appointment' },
    { value: 'payment_issue', label: 'Payment Issue' },
    { value: 'privacy_violation', label: 'Privacy Violation' },
    { value: 'abusive_language', label: 'Abusive Language' },
    { value: 'false_information', label: 'Providing False Information' },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const reportData = {
        reporterType: 'doctor',
        reporterId: doctordata._id || doctordata.id,
        reportedType: 'user',
        reportedId: appointment.userId,
          ...
          {isSuccess ? (
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600">
                Thank you for reporting. Our admin team will review this case and take appropriate action.
              </p>
            </div>
          ) : (
            /* Report Form */
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800">
                      {appointment.userData?.name || 'User'}
                    </p>
