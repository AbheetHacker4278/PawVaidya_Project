          ...
          <AnimatePresence>
            {doctors.slice(0, 10).map((item, index) => (
              ...
              >
                ...
                <div className='relative h-[220px] overflow-hidden bg-gradient-to-br from-green-50 to-blue-50'>
                  <motion.img 
                  ...
                  <motion.div 
                    className={`absolute top-4 right-4 px-3 py-1.5 rounded-full backdrop-blur-md flex items-center gap-2 shadow-lg ${
                      item.available 
